...
public class Server extends Thread {
     ...
     */  
     public void initializeAccounts()
     {
        ...
        try
        {
         inputStream = new Scanner(new FileInputStream("C:\\Users\\Andre\\eclipse-workspace\\Assignment1\\src\\account.txt"));
        }
    ...
    {  
        ...
        System.out.println(objNetwork.disconnect(objNetwork.getServerIP()));
